...
//declares new array being pushed to
const displayNames = [];

//function that loops through each item in array and returns string
...
// creating greeting function
const greeting = function(firstName, lastName) {
  return `Hello ${firstName} ${lastName}, nice to meet you!`
}

// Tests to see if passing parameters in higher function work from callbacks
console.log(consume(1,2,add));
console.log(consume(1,2,multiply));
console.log(consume('Chayce', 'Solchaga', greeting));
...
****** I already defaulted to arrow functions - see lines 92 and 94 ***********
*/
